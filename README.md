...
# cordova-plugin-inappbrowser-x5

<span style='color: red;'>
<p>因本人其他项目需要，此插件与原插件(cordova-plugin-inappbrowser)修改同一个函数“cordova.InAppBrowser”。</p>
<p>Due to my other project needs, this plugin modifies the same function 'cordova.InAppBrowser' as the original plugin (cordova-plugin-inappbrowser).</p>

<p>本插件基于原插件的4.1.0版本修改，以使用腾讯x5内核来打开web界面。</p>
<p>This plugin is modified based on version 4.1.0 of the original plugin to use Tencent x5 kernel to open the web interface.</p>
</span>
